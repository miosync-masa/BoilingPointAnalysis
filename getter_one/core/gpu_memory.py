...
class GPUMemoryManager:
    ...
    def allocate(
        self, size_bytes: int, name: str | None = None, dtype: type = np.float32
    ) -> bool:
        """
        メモリ割り当て可能かチェック
    ...
    @contextmanager
    def batch_context(self, size_bytes: int, name: str | None = None):
        """
...
class GPUMemoryPool:
    ...
    def get_block(self, size: int | None = None) -> tuple[int, Any]:
        """
        ブロックを取得
